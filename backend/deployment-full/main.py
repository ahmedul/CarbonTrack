...
import csrd
from app.api.v1 import achievements, recommendations, admin
...
# =============================================================================
# 👥 ADMIN ENDPOINTS - Now handled by admin router (app/api/v1/admin.py)
# =============================================================================
# Admin endpoints moved to dedicated router for better organization
# Full implementation with CSRD visibility and comprehensive analytics
# Access via /api/v1/admin/* endpoints with proper authentication
